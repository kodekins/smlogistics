        ...
        <div className="container">
          <div className="sec-title center text-center tg-heading-subheading animation-style2">
            ...
            <h2 className="sec-title__title tg-element-title">
              Latest News Directly <br /> From Our <span>Blog</span>
            </h2>
          </div>
          <div className="row">
            {/* Blog One Single */}
                  ...
                  <div className="blog-one__single-content-inner">
                    ...
                    <h2>
                      <Link to="/blog-details">
                        How Will You Know Success <br /> When it Show Up?
                      </Link>
                    </h2>
                    <p>
                      Logistic service provider company plays a pivotal role in
                      the global supply chain ecosystem by efficiently...
                    </p>
              ...
              <div className="blog-one__single">
                ...
                <div className="blog-one__single-content">
                  ...
                  <div className="blog-one__single-content-inner">
                    ...
                    <h2>
                      <Link to="/blog-details">
                        Mastering Last Mile Delivery <br /> Strategies for Success
                      </Link>
                    </h2>
                    <p>
                      Logistic service provider company plays a pivotal role in
              ...
              <div className="blog-one__single">
                ...
                <div className="blog-one__single-content">
                  ...
                  <div className="blog-one__single-content-inner">
                    ...
                    <h2>
                      <Link to="/blog-details">
                        Logistics Announces Launch <br /> of Greenhouse Gas
                      </Link>
                    </h2>
                    <p>
                      Logistic service provider company plays a pivotal role in
