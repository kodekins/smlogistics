...
import pricingPattern from '../../assets/images/pattern/pricing-v1-pattern.png';
    ...
    return (
        <section className="pricing-one">
            <div className="pricing-one__pattern"
                style={{ backgroundImage: `url(${pricingPattern})` }} ></div>
                            ...
                            <div className="pricing-one__single-inner">
                                <div className="table-header">
                                    <div className="img-box">
                                        <img src={pricingImg1} alt="Road Cargo" />
                                    </div>
                    ...
                    <div className="col-xl-4 col-lg-4 wow fadeInDown" data-wow-delay=".3s">
                        <div className="pricing-one__single">
                            <div className="pricing-one__single-inner">
                                <div className="table-header">
                                    <div className="img-box">
                                        <img src={pricingImg2} alt="Sea Freight" />
                                    </div>
                                    <div className="title-box">
                                        <h2>Sea Freight</h2>
                    ...
                    <div className="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay=".3s">
                        <div className="pricing-one__single">
                            <div className="pricing-one__single-inner">
                                <div className="table-header">
                                    <div className="img-box">
                                        <img src={pricingImg3} alt="Ship Cargo" />
                                    </div>
                                    <div className="title-box">
                                        <h2>Ship Cargo</h2>
